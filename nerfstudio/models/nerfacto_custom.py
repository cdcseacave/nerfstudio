"""
Custom NeRF implementation that combines many recent advancements.
"""
...
@dataclass
class NerfactoCustomModelConfig(ModelConfig):
    """Nerfacto Model Config"""

    _target: Type = field(default_factory=lambda: NerfactoCustomModel)
...
class NerfactoCustomModel(Model):
    """Nerfacto model
    ...
    config: NerfactoCustomModelConfig
