...
class GaussianSplattingModel(Model):
    ...
    def add_init_sphere_pts(self):
        ...
        self.features_dc  = torch.nn.Parameter(torch.cat([self.features_dc.detach(),sphere_shs_0],      dim=0))
        self.features_rest= torch.nn.Parameter(torch.cat([self.features_rest.detach(),sphere_shs_rest], dim=0))
    ...
    def populate_modules(self):
        ...
        if self.seed_pts is not None and not self.config.random_init:
            ...
            shs = torch.zeros((self.seed_pts[1].shape[0], dim_sh, 3), dtype=torch.float)
    ...
    def split_gaussians(self, split_mask, samps):
        ...
        return new_means, new_features_dc, new_features_rest, new_opacities, new_scales, new_quats, new_visibility
    ...
    def dup_gaussians(self, dup_mask):
        ...
        return dup_means, dup_features_dc, dup_features_rest, dup_opacities, dup_scales, dup_quats, dup_visibility
